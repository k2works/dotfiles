...
(define-key howm-mode-map "\C-c\C-c\C-c" 'howm-save-and-kill-buffer/screen)
...
;;; org-modeをMarkDownで出力できるようにする
(load "~/.emacs.d/elisp/org-export-generic.el")
(load "~/.emacs.d/public_repos/ORGMODE-Markdown/markdown.el")

;;; PATHの設定(http://sakito.jp/emacs/emacsshell.html)
